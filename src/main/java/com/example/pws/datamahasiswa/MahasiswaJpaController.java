...
import com.example.pws.datamahasiswa.exceptions.NonexistentEntityException;
...
public class MahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.example.pws_datamahasiswa_jar_0.0.1-SNAPSHOTPU");

    MahasiswaJpaController() {
    }
